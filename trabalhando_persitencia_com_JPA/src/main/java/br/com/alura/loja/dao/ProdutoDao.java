...
public class ProdutoDao {
    ...
    public List<Produto> buscarPorParametrosComCriteria(String nome, BigDecimal preco, LocalDate dataCadastro){
        ...
        Root<Produto> from = query.from(Produto.class);//Faz a consulta na entidade Produto
    ...
    /*
        ...
        em.createNamedQuery() -> Chama a NamedQuery da entidade, passando seu name e sua classe.
    */
